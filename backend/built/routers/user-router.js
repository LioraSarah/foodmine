...
router.post("/login", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, lowerCaseEmail, user, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.UserModel.findOne({ email: lowerCaseEmail })];
            case 1:
                user = _c.sent();
                console.log(user);
                _b = user;
            ...
            case 3:
                if (_b) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("Email or password does not match");
                }
                return [2 /*return*/];
        }
    });
...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, address, lowerCaseEmail, user, encryptedPsw, newUser, dbUser, registerUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (user) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).send('User already exist');
                    return [2 /*return*/];
                }
                return [4 /*yield*/, bcryptjs_1.default.hash(password, 10)];
            case 2:
                encryptedPsw = _b.sent();
                newUser = {
                    id: '',
                    name: name,
            ...
            case 3:
                dbUser = _b.sent();
                registerUser = generateTokenRes(dbUser);
...
var generateTokenRes = function (user) {
    var token = jsonwebtoken_1.default.sign({ id: user.id, email: user.email, isAdmin: user.isAdmin }, "randomText", { expiresIn: "30d" });
    user.token = token;
    return user;
};
